...
/*some edits by Nina Tobio in Dec 2013*/
...
(function($) {
    ...
    var TC_Instance = function(element, options) {
        ...
        this.data.attributes.item_size = Math.min(this.data.attributes.canvas[0].width / 2, this.data.attributes.canvas[0].height);
